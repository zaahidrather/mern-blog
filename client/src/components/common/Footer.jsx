    ...
    <footer className="border border-t-8 border-teal-500">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col gap-10 sm:flex-row sm:justify-between">
          ...
          >
            <span className="px-2 py-1 rounded-lg text-white bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500">
              Zahid&apos;s
            </span>{" "}
            Blog
          </Link>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-5">
            ...
            <a
              href="https://https://www.instagram.com/zaahidrather/"
